# This file contains various helper functions that are used by the web-app. Instead of defining them directly in the web_app.py file, it can be imported and used, which reduces clutter and improves performance.
